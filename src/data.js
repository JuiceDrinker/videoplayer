export const data = [
    ...
    id: 1,
    name: "Aquaman",
    description: "Halvmänniskan och halvatlanten Arthur Curry får veta att han är arvinge till undervattensriket Atlantis och måste träda fram för att leda sitt folk och bli en hjälte. Där börjar hans livs resa - en resa som inte bara tvingar honom att möta sitt sanna jag, utan också upptäcka om han är värdig det han föddes till att bli: en kung. ",
    image: "https://iptvimagecache-playplus-prod-vip.han.telia.se/crop/200x290/http%3A%2F%2Fiptvlogin.telia.se%2F%2FSF%20Anytime%2F4749441.jpg",
    video: "http://mirrors.standaloneinstaller.com/video-sample/dolbycanyon.mp4"
    },
    {
    id: 2,
    name: "Incoming",
